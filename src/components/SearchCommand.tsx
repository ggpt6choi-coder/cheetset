...
export default function SearchCommand({ open, setOpen, lang, toolsDict }: SearchCommandProps) {
    ...
    return (
        <Command.Dialog
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[640px] bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden z-[100]"
